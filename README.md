...
launch from the command line:
    ...
    $ lein run -m portfolio-website.web
...
get the app created:
    ...
    $ heroku apps:create portfolio-website
    Creating portfolio-website... done, stack is cedar
    http://portfolio-website.herokuapp.com/ | git@heroku.com:portfolio-website.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://portfolio-website.herokuapp.com deployed to Heroku

    To git@heroku.com:portfolio-website.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://portfolio-website.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@portfolio-website.herokuapp.com/repl
